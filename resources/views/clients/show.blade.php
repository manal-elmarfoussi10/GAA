            ...
            @if($client->$field)
                ...
                <div class="border rounded-lg overflow-hidden">
                    <div class="bg-gray-100 h-48 flex items-center justify-center">
                        ...
                        @else
                            <img src="{{ Storage::url($client->$field) }}" alt="{{ $label }}" class="object-contain w-full h-full">
                        @endif
                    </div>
                    <div class="p-3">
                        <h3 class="font-medium text-gray-800">{{ $label }}</h3>
                        <div class="flex justify-between mt-2">
                            <a href="{{ Storage::url($client->$field) }}" target="_blank" class="text-cyan-600 hover:text-cyan-800 text-sm flex items-center">
                            ...
                            <a href="{{ Storage::url($client->$field) }}" download class="text-gray-600 hover:text-gray-800 text-sm flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<div class="bg-white rounded-xl shadow-md p-6 mb-8">
    ...
    <div id="newConversationForm" class="hidden mb-8">
        <form method="POST" action="{{ route('conversations.store', $client->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
                            ...
                            <div class="email mb-4">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        @if($email->file_path)
                                            <div class="mt-2">
                                                <a href="{{ Storage::url($email->file_path) }}" target="_blank" class="text-cyan-600 hover:text-cyan-800 flex items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                    </svg>
                                                    {{ $email->file_name }}
                                        ...
                                        <div class="reply">
                                            <div class="flex items-start">
                                                ...
                                                <div class="ml-3">
                                                    ...
                                                    @if($reply->file_path)
                                                        <div class="mt-2">
                                                            <a href="{{ Storage::url($reply->file_path) }}" target="_blank" class="text-cyan-600 hover:text-cyan-800 flex items-center">
                                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                                </svg>
                                                                {{ $reply->file_name }}
